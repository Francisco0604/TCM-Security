...
U can try to crack the dcc hash or other hashes and c if anything good u get

The main things u are looking for are the SAM hashes
...
Guest, defaultaccount and utility account are not tht grt
...
Go through all the accounts u can access through using secretsdump
