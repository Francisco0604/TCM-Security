...
Following i wil jst list down the walkthorugh
Do an nmap scan
...
the x64 is a reference for 64 bit (additonal info if uk tht the system is 32 bits set to 32 bits)
...
if u set up evrything and run this wil probably brk the system and restart it
give it a try if u wnt 
